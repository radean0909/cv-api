		...
		employers: [
			{
				...
				description: 'Solomid is a company that has a network of <strong>high-traffic</strong> (~180-200 mil pageviews/month) web-apps predominately focused on the video-game industry surrounding <strong>League of Legends</strong>. I was tasked to <strong>design</strong> and <strong>implement</strong> a cohesion strategy for their outdated and unorganized apps. In addition, I aided in the <strong>hiring</strong> and onboarding of an entire dev team, complete with interns. I was directly involved in every project and the project lead on several significant overhauls. Work included <strong>integrating new designs</strong> into existing sites, large scale <strong>data migrations</strong>, creation of a <strong>service-based</strong> methodology and several designing and developing <strong>complex RESTful APIs</strong>.',
