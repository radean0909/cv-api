		...
		employers: [
			{
				...
				achievements: '<ul><li>Overhauled outdated and custom PHP projects.</li><li>Moved towards <strong>modular</strong> development practices.</li><li>Several high profile <strong>emergency deployments</strong> of complete site overhauls.</li><li>Development of several integral <strong>NodeJS</strong> and <strong>Phalcon</strong> APIs.</li><li>Integration and set-up of purchased properties.</li></ul>',
				difficulties: '<ul><li>Interfaced with entrierly remote team.</li><li>Original project creators no longer part of company with minimal direction, documentation or guidence and highly customized code.</li><li>Implementing significant redesigns on an already popular network of sites with strong brand loyalty.</li><li>Adjusting tech stack based upon new hire\'s expertise.</li></ul>'
			},
			{
				name: 'Blue Sun Media',
				title: 'Web Developer',
				...
				achievements: '<ul><li>Designed and created complex project-based non-profit directory <a href="http://www.csrmatch.org/" target="_blank">CSR Match</a> with a robust searching mechanism.</li><li>Helped to develop and deploy several improvements for <a href="http://www.jerryspinger.com" target="_blank">media</a> <a href="http://www.richeisenshow.com/" target="_blank">personality</a> <a href="http://www.danpatrick.com/" target="_blank">sites</a>.</li><li>Launched a private and commercial <a href="http://www.artiequitter.com/" target="_blank"> Artie Lange podcast</a>.</li><li>Overhauled wordpress data designs for projects that required custom mySQL schemas.</li></ul>',
				difficulties: '<ul><li>Interfaced with entrierly remote team.</li><li>Frequent pivoting due to client scope creep or focus pivots.</li><li>Frequent and tight deadlines.</li><li>Zero downtime tolerance.</li><li>Rich multimedia, highly customized Wordpress sites.</li></ul>'
			},
			{
				...
				achievements: '<ul><li>Launched project with original team.</li><li>Acted as <strong>Project Lead</strong> for new, larger development team.</li><li>Participated and <strong>oversaw</strong> the complete visual overhaul of the site and </li><li><strong>Implemented client-facing custom dashboard and management app</strong>.</li><li>Designed and implemented a <strong>large scale, modularized payment service</strong> overhaul.</li></ul>',
				difficulties: '<ul><li>Very frequent pivots.</li><li>Highly complex and customized Wordpress install.</li><li>Rapidly changing company structure often left team wondering who to report to.</li><li>Significant ground-breaking precedents being set.</li></ul>'
			},
			{
